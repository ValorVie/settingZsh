...
require_contains "$EDITOR_SCRIPT" 'extract_dir_name=' "editor script missing neovim extracted dir name"
require_contains "$EDITOR_SCRIPT" 'extract_dir_path="$tmp_dir/$extract_dir_name"' "editor script missing neovim extracted dir path"
require_contains "$EDITOR_SCRIPT" 'cp -R "$extract_dir_path/." "$HOME/.local/"' "editor script missing neovim copy source path"
